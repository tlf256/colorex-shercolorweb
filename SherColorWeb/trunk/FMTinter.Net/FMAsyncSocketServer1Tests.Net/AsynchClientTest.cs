...
namespace AsynchClientTest
{
    ...
    public class AsynchronousClientTest
    {
        ...
        public  void StartClient()
        {
            ...
            Thread server = new Thread(StartListener);
            server.Start();
            ...
            try
            {
                ...
                */
                /*
                Send(client, "This is another test baby");
                sendDone.WaitOne();
                Receive(client);
                receiveDone.WaitOne();
                Console.WriteLine("No Waiting around here.");
                // Release the socket.  
