...
public interface CI62SWWXDSV4DLL extends Library {
	CI62SWWXDSV4DLL INSTANCE = (CI62SWWXDSV4DLL) Native.loadLibrary(
        (Platform.isWindows() ? "Ci62+SWW" : "simpleDLLLinuxPort"), CI62SWWXDSV4DLL.class);
