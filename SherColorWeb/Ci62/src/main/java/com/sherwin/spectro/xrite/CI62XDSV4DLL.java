...
public interface CI62XDSV4DLL extends Library {
	CI62XDSV4DLL INSTANCE = (CI62XDSV4DLL) Native.loadLibrary(
        (Platform.isWindows() ? "Ci62" : "simpleDLLLinuxPort"), CI62XDSV4DLL.class);
