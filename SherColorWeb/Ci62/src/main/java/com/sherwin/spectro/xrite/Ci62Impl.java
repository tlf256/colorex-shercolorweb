...
public class Ci62Impl extends AbstractSpectroImpl {
	static Logger logger = LogManager.getLogger(Ci62Impl.class);
	private CI62XDSV4DLL sDll;
	private static String DEVICENAME = "Ci62";
	//force to default to en_US for now...
	
	Locale locale = new Locale("en", "US");
	ResourceBundle resourceBundle = ResourceBundle.getBundle("Ci62Errors",locale);
	
private void CreateDllObj() {
	try {
		NativeLibrary.addSearchPath(getSpectroDllName(), getSpectroDllPath());
		sDll = CI62XDSV4DLL.INSTANCE;
