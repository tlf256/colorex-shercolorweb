...
public class Ci52SWSImpl extends AbstractSpectroImpl {
	static Logger logger = LogManager.getLogger(Ci52SWSImpl.class);
	private CI52SWSXDSV4DLL sDll;
	private static String DEVICENAME = "Ci52+SWS";

	//force to default to en_US for now...
	
	Locale locale = new Locale("en", "US");
	ResourceBundle resourceBundle = ResourceBundle.getBundle("Ci52SWSErrors",locale);
	
private void CreateDllObj() {
	try {
		NativeLibrary.addSearchPath(getSpectroDllName(), getSpectroDllPath());
		sDll = CI52SWSXDSV4DLL.INSTANCE;
