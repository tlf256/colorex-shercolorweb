...
public class Ci52SWWImpl extends AbstractSpectroImpl {
	static Logger logger = LogManager.getLogger(Ci52SWWImpl.class);
	private CI52SWWXDSV4DLL sDll;
	private static String DEVICENAME = "Ci52+SWW";

	//force to default to en_US for now...
	
	Locale locale = new Locale("en", "US");
	ResourceBundle resourceBundle = ResourceBundle.getBundle("Ci52SWWErrors",locale);
	
private void CreateDllObj() {
	try {
		NativeLibrary.addSearchPath(getSpectroDllName(), getSpectroDllPath());
		sDll = CI52SWWXDSV4DLL.INSTANCE;
...
//		setSpectroDllPath("C:\\XRite\\XDS4_Ci52+SWS_SDK_1.2.4 Beta\\Drivers\\Win32\\");
//	} else if (strBitness.equals("64")) {
//		setSpectroDllPath("C:\\XRite\\XDS4_Ci52+SWS_SDK_1.2.4 Beta\\Drivers\\x64\\");
//	} else {
//		this.errorCode = 1;
	...
	try {
		...
		if(m != null){
			...
			if(str !=null){
				...
				case "GetCalMode":
				case "Ci52GetInstSerial":
				case "Ci52GetOEMSerial":
				case "Ci52GetModelType":
				case "Ci52GetClock":
				case "Ci52GetVersion":
				case "Ci52GetCalPlaqueSerial":
				case "Ci52GetCheckPlaqueSerial":
				case "Ci52GetCalStatus":
				case "Ci52GetCalWhiteTimeout":
				case "Ci52GetVolumeLevel":
				case "Ci52GetErrorLog":
				case "Ci52ClearErrorLog":
				case "GetCalStatus":
				...
				case "SetVolumeLevel":					
				case "Ci52SetCalWhiteTimeout":
				case "Ci52SetVolumeLevel":
				case "Ci52SetClock":
					...
					break;
				case "Ci52GetCalPlaqueSpin":
				case "Ci52GetCalPlaqueSpex":
				case "Ci52GetCheckPlaqueSpin":
				case "Ci52GetCheckPlaqueSpex":
					System.out.println(this.getClass().getSimpleName() + " - Sending " + strCmd + " to device" );
					try {
...
public SpectralCurve SWMeasure() {
	...
	try {
		...
		if (sDll!=null) {
			...
			//First, force the Ci52 to NOT be in extended reflectance mode.
			String returnResponse = sDll.Execute("param set UseExtendedRefls 0");
...
public boolean MeasureGreen(){
	...
	try {
		...
		checkPlaque = Ci52GetCheckPlaqueSpin();
...
public String Ci52ClearErrorLog() {
	String returnResponse = "";
	try {
		if (sDll==null) {
			CreateDllObj();
...
public String Ci52GetInstSerial() {
	String returnResponse = "";
	try {
		if (sDll==null) {
			CreateDllObj();
...
public String Ci52GetOEMSerial() {
	String returnResponse = "";
	try {
		if (sDll==null) {
			CreateDllObj();
...
public String Ci52GetModelType() {
	String returnResponse = "";
	try {
		if (sDll==null) {
			CreateDllObj();
...
public String SetClock(String strTimeArgs) {
    return Ci52SetClock(strTimeArgs);
}


public String Ci52SetClock(String strTimeArgs) {
	String returnResponse = "";
	try {
		if (sDll==null) {
			CreateDllObj();
...
public String GetVolumeLevel() {
	return Ci52GetVolumeLevel();
}

public String Ci52GetVolumeLevel() {
	String returnResponse = "";
	try {
		if (sDll==null) {
			CreateDllObj();
...
public String GetCalWhiteTimeout() {
	return Ci52GetCalWhiteTimeout();
}

public String Ci52GetCalWhiteTimeout() {
	String returnResponse = "";
	try {
		if (sDll==null) {
			CreateDllObj();
...
public String SetVolumeLevel(String strParamArgs) {
	return Ci52SetVolumeLevel(strParamArgs);
}

public String Ci52SetVolumeLevel(String strParamArgs) {
	String returnResponse = "";
	try {
		if (sDll==null) {
			CreateDllObj();
...
public String SetCalWhiteTimeout(String strParamArgs) {
	return Ci52SetCalWhiteTimeout(strParamArgs);

}

public String Ci52SetCalWhiteTimeout(String strParamArgs) {
	String returnResponse = "";
	try {
		if (sDll==null) {
			CreateDllObj();
...
public String GetVersion() {
	return Ci52GetVersion();
}

public String GetCalPlaqueSerial() {
	return Ci52GetCalPlaqueSerial();
}

public String GetCheckPlaqueSerial() {
	return Ci52GetCheckPlaqueSerial();
}
...
public String Ci52GetCalStatus() {
	String returnResponse = "";
	try {
		if (sDll==null) {
			CreateDllObj();
...
public SpectralCurve Ci52GetCalPlaqueSpin() {
	String returnResponse = "";
...
public SpectralCurve Ci52GetCalPlaqueSpex() {
	String returnResponse = "";
	SpectralCurve returnCurve = null;
	try {
		if (sDll==null) {
...
public String Ci52GetCalPlaqueSerial() {
	String returnResponse = "";
	try {
		if (sDll==null) {
			CreateDllObj();
...
public String Ci52GetCheckPlaqueSerial() {
	String returnResponse = "";
	try {
		if (sDll==null) {
			CreateDllObj();
...
public SpectralCurve Ci52GetCheckPlaqueSpin() {
	String returnResponse = "";
	SpectralCurve returnCurve = null;
	try {
		if (sDll==null) {
...
public SpectralCurve Ci52GetCheckPlaqueSpex() {
	String returnResponse = "";
	SpectralCurve returnCurve = null;
	try {
		if (sDll==null) {
