...
import com.sherwin.spectro.xrite.CI52SWSXDSV4DLL;
import com.sun.jna.Library;
import com.sun.jna.Native;
import com.sun.jna.Platform;

public interface CI52SWSXDSV4DLL extends Library {
	CI52SWSXDSV4DLL INSTANCE = (CI52SWSXDSV4DLL) Native.loadLibrary(
        (Platform.isWindows() ? "Ci52+SWS" : "simpleDLLLinuxPort"), CI52SWSXDSV4DLL.class);
