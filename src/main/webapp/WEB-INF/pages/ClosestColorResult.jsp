...
<html lang="en">
	<head>
		...
		<script type="text/javascript" charset="utf-8" src="script/closestColorResult-1.5.2.js"></script>
		<style>
			.sw-bg-main {
	...
	<body>
		...
		<div class="container-fluid">
				...
				<div class="col-lg-2 col-md-2 col-sm-1"></div>
           		<div class="col-lg-8 col-md-8 col-sm-10">
           			<table id="closestSwColor_table" class="table table-striped table-bordered" style="width:100%">
           			  <caption><strong><s:text name="closestColors.sherwinColors"/></strong></caption>
						<thead>
							<tr>
				...
				<div class="col-lg-2 col-md-2 col-sm-1"></div>
           		<div class="col-lg-8 col-md-8 col-sm-10">
           			<table id="closestCmptColor_table" class="table table-striped table-bordered" style="width:100%">
           			  <caption><strong><s:text name="closestColors.competitiveColors"/></strong></caption>
						<thead>
							<tr>
			...
			<div class="row">
				...
				<div class="col-lg-8 col-md-8 col-sm-10">
					<s:submit class="btn btn-primary mb-5 mt-2 mx-1" value="%{getText('closestColors.newMeasurement')}" action="closestColorMeasureAction"/>
