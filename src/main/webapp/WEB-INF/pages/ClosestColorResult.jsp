	...
	<body>
		...
		<div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-lg-2 col-md-2 col-sm-3 col-xs-4">
					<span class="chip p-0" style="background: <s:property value="#measurement.rgbHex"/>;"></span>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-7 col-xs-8">
				</div>
				<div class="col-lg-4 col-md-4 col-sm-1 col-xs-0">
			...
			<div class="row d-none" id="results">
				<div class="col-lg-2 col-md-2 col-sm-1">
           		...
           		<div class="col-lg-8 col-md-8 col-sm-10">
           			<table id="closestColor_table" class="table table-striped table-bordered" style="width:100%">
						<thead>
							<tr>
								<th>Color Company</th>
								<th>Color ID</th>						
