...
public class ProcessFormulaJsonAction extends ActionSupport implements SessionAware, LoginRequired  {

	private DataInputStream inputStream;
	private byte[] data;
	static Logger logger = LogManager.getLogger(ProcessFormulaJsonAction.class);
	...
	public String print() {
		...
		try {
			...
			setData(new byte[(int)file.length()]);
